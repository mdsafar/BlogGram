...
import {ProtectedRoute,AdminRoute} from './components/routes/ProtectedRoute.js';
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path='/b/:slug' element={<ProtectedRoute element={<BlogDetails />} />} />
        ...
        <Route path='/:name' element={<ProtectedRoute element={<UserDetails socket={socket} />} />} />
        <Route path='/direct/inbox/' element={<ProtectedRoute element={<Chats socket={socket} />} />} />
        <Route path='/direct/t/:roomId' element={<ProtectedRoute element={<ChatRoom socket={socket} />} />} />
